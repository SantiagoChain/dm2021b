...
palancas$version  <- "v014"   #Muy importante, ir cambiando la version

palancas$variablesdrift  <- c("Scplazofijo", "Master_madelantopesos", "Visa_delinquency", "ctarjeta_master", 
                              "Visa_mconsumospesos", "mtarjeta_master_descuentos", 
                              "ccajeros_propios_descuentos", "cforex", "Smlimitecompra", "Smtarjdeb_disc", 
                              "Master_mconsumospesos", "Master_cadelantosefectivo", "Smctacte", "Ssumastarj_disc", 
                              "cseguro_auto", "mv_madelantopesos", "ccheques_emitidos", "Sforex4", 
                              "Smtarjetas_cuad", "Smtarjdisc", "ccheques_depositados", "ctarjeta_visa", 
                              "Visa_cadelantosefectivo", "Smpayrolltrx", "cprestamos_prendarios", "mplazo_fijo_pesos", 
                              "minversion1_pesos", "Master_mconsumosdolares", "Scpayrolltrx", "cpagodeservicios", "minversion1_dolares",
                              "Master_Finiciomora", "mforex_sell", "mtarjeta_visa_descuentos", "cinversion1", "mvr_madelantopesos",
                              "cforex_buy", "Visa_status", "tcuentas", "mv_status03", "ctarjeta_master_descuentos", "tpaquete3",
                              "mcajeros_propios_descuentos", "active_quarter", "cforex_sell", "Visa_madelantopesos", "Sdiscreta2_pagomin",
                              "mcheques_depositados_rechazados", "mcaja_ahorro_adicional", "Visa_Finiciomora", "mprestamos_prendarios",
                              "cplazo_fijo", "Master_delinquency", "mv_status04", "ctarjeta_visa_descuentos", "mv_status06", "cinversion2",
                              "Sforex1", "mforex_buy", "Scdescuentos", "Sctacja", "Master_status", "Smforex", "Sctarjdisc", 
                              "Master_msaldodolares", "mv_mpagosdolares", "Master_mpagado", "ccajas_depositos", "Smlimitecompra_sueldo_cuad",
                              "Sctarjetas", "ccajas_otras", "Sforex6", "Sforex7", "mcheques_depositados", "mcheques_emitidos", "Sforex5",
                              "mttarjeta_master_debitos_automaticos", "ccajas_transacciones", "cliente_vip", "Smcjahrro", "tcallcenter",
                              "minversion2", "Scliente_edad_log", "mvr_mpagosdolares", "Ssueldo_trx_mes_cuad", "mpagodeservicios", "mvr_Master_mlimitecompra",
                              "ctarjeta_master_debitos_automaticos", "Master_mpagosdolares", "mv_status02", "Visa_mpagosdolares", "mprestamos_hipotecarios",
                              "Sforex3", "catm_trx_other", "ctarjeta_master_transacciones", "mvr_msaldodolares", "matm_other",
                              "Scservicios", "Master_cconsumos", "cseguro_vida", "Visa_msaldodolares", "Master_mconsumototal",
                              "cseguro_vivienda", "mtarjeta_master_consumo", "mv_msaldodolares", "Scliente_edad_cuad", "mvr_mpagado",
                              "Sforex2", "catm_trx", "mv_mpagominimo_cuad", "Smctacte2", "mpagomiscuentas", "mv_mconsumototal",
)   #aqui van las columnas que se quieren eliminar

palancas$deflacionar <- TRUE
...
#------------------------------------------------------------------------------
#Corrige poniendo a NA las variables que en ese mes estan da̱adas
...
correr_todo  <- function( palancas )
{
  ...
  AgregarMes( dataset )  #agrego el mes del a̱o
  
  if( palancas$deflacionar )  deflacionar( dataset )  #esta linea debe ir primera  !!
