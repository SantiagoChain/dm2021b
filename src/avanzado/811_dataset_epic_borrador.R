...
palancas$variablesdrift  <- c("Visa_delinquency", "Visa_mconsumospesos", "mtarjeta_master_descuentos", "ccajeros_propios_descuentos", 
                              "cforex", "Smlimitecompra_sueldo", "Smtarjdeb", "Smtarjdeb_disc", "Master_mconsumospesos", )   #aqui van las columnas que se quieren eliminar
