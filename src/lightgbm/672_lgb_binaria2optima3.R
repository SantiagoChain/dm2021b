...
karch_generacion  <- "~/buckets/b1/datasets/paquete_premium_202011_ext11.csv"
karch_aplicacion  <- "~/buckets/b1/datasets/paquete_premium_202101_ext11.csv"
...
campos_malos  <- c( "mpasivos_margen", "mactivos_margen", "mrentabilidad", "mrentabilidad_anual", "cpayroll_trx", "numero_de_cliente")   #aqui se deben cargar todos los campos culpables del Data Drifting
