...
hs <- makeParamSet( 
         ...
         makeIntegerParam("min_data_in_leaf", lower= 0    , upper= 7000),
         makeIntegerParam("num_leaves",       lower=16L   , upper= 2048L),
         makeNumericParam("prob_corte",       lower= 0.025, upper=    0.055)
        )

campos_malos  <- c( "mpasivos_margen", "mactivos_margen", "mrentabilidad", "mrentabilidad_annual",
                    "mcuenta_corriente", "mcaja_ahorro", "mtarjeta_visa_consumo", "ctarjeta_master_transacciones",
                    "ctarjeta_visa_transacciones", "mtarjeta_master_consumo", "Smtarj", "Sctarj", "cprestamos_personales",
                    "cplazo_fijo", "mplazo_fijo", "cpayroll_trx", "mpayroll",  "mttarjeta_visa_debitos_automaticos",
                    "mttarjeta_master_debitos_automaticos", "ccajeros_propios_descuentos", "ccheques_emitidos",
                    "Master_msaldototal", "Master_mconsumospesos", "Master_mconsumototal", "Visa_msaldototal",
                    "Visa_msaldopesos", "Smtarjdeb", "Ssumastarj")   #aqui se deben cargar todos los campos culpables del Data Drifting
