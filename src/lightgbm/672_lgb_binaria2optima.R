...
campos_malos  <- c( "mpasivos_margen", "mactivos_margen", "mrentabilidad", "mrentabilidad_anual",
                    ...
                    "ctarjeta_visa_descuentos", "Visa_madelantopesos", "cinversion1", "minversion2", "tpaquete4",
                    "mcheques_depositados", "cseguro_vida", "tcuentas", "mtarjeta_visa_descuentos", "catm_trx_other",
                    "mcaja_ahorro_adicional", "Master_cadelantosefectivo", "matm_other", "ccajas_extracciones",
                    "mcheques_emitidos", "cforex_sell", "ccajas_depositos", "Master_msaldodolares",
                    "ctarjeta_visa", "Master_mpagado", "ccheques_emitidos", "ccheques_depositados", "active_quarter",
                    "ctarjeta_master_debitos_automaticos", "cdescuentos", "Master_mpagosdolares", "Master_mconsumosdolares",
                    "Visa_mpagosdolares", "mforex_sell", "ccajas_otras", "mttarjeta_master_debitos_automaticos", 
                    "servicios_sueldo", "servicios_sueldo_edad_trx", "tpaquete1", "Visa_msaldodolares", "cforex",
                    "cseguro_vivienda", "internet"	)   #aqui se deben cargar todos los campos culpables del Data Drifting
