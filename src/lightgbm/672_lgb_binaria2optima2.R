...
karch_generacion  <- "~/buckets/b1/datasets/paquete_premium_202011_extG9.csv"
karch_aplicacion  <- "~/buckets/b1/datasets/paquete_premium_202101_extG9.csv"
...
campos_malos  <- c( "mpasivos_margen", "mactivos_margen", "mrentabilidad", "mrentabilidad_anual",
                    "Visa_cadelantosefectivo", "mcajeros_propios_descuentos", "Visa_delinquency", "Master_madelantopesos",
                    "ctarjeta_visa_descuentos", "Visa_madelantopesos", "cinversion1", "minversion2",
                    "tpaquete4", "mcheques_depositados", "cseguro_vida", "tcuentas",
                    "mtarjeta_visa_descuentos", "catm_trx_other", "mcaja_ahorro_adicional", "Master_cadelantosefectivo",
                    "matm_other", "ccajas_extracciones", "mcheques_emitidos", "cforex_sell",
                    "ccajas_depositos", "Master_msaldodolares", "ctarjeta_visa", "Master_mpagado",
                    "ccheques_emitidos", "ccheques_depositados", "active_quarter", "ctarjeta_master_debitos_automaticos",
                    "cdescuentos", "Master_mpagosdolares", "Master_mconsumosdolares", "Visa_mpagosdolares",
                    "mforex_sell", "ccajas_otras", "mttarjeta_master_debitos_automaticos", "servicios_sueldo",
                    "servicios_sueldo_edad_trx", "tpaquete1", "Visa_msaldodolares", "cforex",
                    "cseguro_vivienda", "internet", "mv_status01", "mv_status02",
                    "mv_status03", "mv_status04", "mv_status05", "mv_status06",
                    "mv_status07", "mv_mfinanciacion_limite", "mv_Finiciomora", "mv_msaldopesos",
                    "mv_msaldodolares", "mv_mconsumospesos", "mv_mconsumosdolares", "mv_mlimitecompra",
                    "mv_madelantopesos", "mv_madelantodolares", "mv_fultimo_cierre", "mv_mpagado",
                    "mv_mpagospesos", "mv_mpagosdolares", "mv_fechaalta", "mv_mconsumototal",
                    "mv_cconsumos", "mv_cadelantosefectivo", "mvr_Master_mlimitecompra", "mvr_Visa_mlimitecompra",
                    "mvr_msaldototal", "mvr_msaldopesos", "mvr_msaldopesos2", "mvr_msaldodolares",
                    "mvr_msaldodolares2", "mvr_mconsumospesos", "mvr_mconsumosdolares", "mvr_madelantopesos",
                    "mvr_madelantodolares", "mvr_mpagado", "mvr_mpagospesos", "mvr_mpagosdolares",
                    "mvr_mconsumototal", "mvr_mpagominimo")   #aqui se deben cargar todos los campos culpables del Data Drifting
